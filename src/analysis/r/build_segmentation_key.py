...
def get_keys(object, background):
    ...
    """
    keynames = ["Imprinted Object Imprinted Background, Novel Object Imprinted Background",
               "Imprinted Object Imprinted Background, Novel Object Novel Background",
...
def main():
    ...
    keys_ship_A = get_keys("ship","backgroundA")
    keys_ship_B = get_keys("ship", "backgroundB")

    keys_ship_C = get_keys("ship", "backgroundC")
    
    keys_fork_A = get_keys("fork","backgroundA")
    keys_fork_B = get_keys("fork", "backgroundB")
    keys_fork_C = get_keys("fork", "backgroundC")
    ...
    try:
        with open(csv_file, 'w') as csvfile:
            writer = csv.DictWriter(csvfile, fieldnames=["left_right","left","right","imprinting","cond_name"])
            writer.writeheader()
