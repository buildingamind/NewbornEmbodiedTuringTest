...
def resnet34_encoder(first_conv, maxpool1):
    return ResNetEncoder(EncoderBlock, [3, 4, 6, 3], first_conv, maxpool1)



def resnet34_decoder(latent_dim, input_height, first_conv, maxpool1):
    return ResNetDecoder(DecoderBlock, [3, 4, 6, 3], latent_dim, input_height, first_conv, maxpool1)
