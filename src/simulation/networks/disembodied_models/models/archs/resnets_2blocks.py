...
# downsized resnet18 - 2 residual block architecture
def resnet6(pretrained: bool = False, progress: bool = True, **kwargs):
    """
    ...
    return _resnet(BasicBlock, [1, 1, 1, 1], pretrained, progress, **kwargs)
