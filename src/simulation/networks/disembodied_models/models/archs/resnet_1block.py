...
class ResNet(nn.Module):
    ...
    def __init__(
        ...
        first_conv=False, # disable to remove initial conv layers before first residual block
        maxpool1=False
    ):
        ...
        self.inplanes = 3 # what is inplanes and planes in CNN ????
        self.dilation = 1
...
#             self.maxpool = nn.MaxPool2d(kernel_size=1, stride=1)
        ...
        #self.fc = nn.Linear(512 * block.expansion, 512) # changed from 512 to 256
        self.fc = nn.Linear(64*1*1,512)
...
# downsized resnet18
def resnet3(pretrained: bool = False, progress: bool = True, **kwargs):
    """
