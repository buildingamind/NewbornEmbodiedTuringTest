...
class NETT:
    ...
    def analyze(config: str,
        ...
        Args:
            config (str): The configuration of the experiment to be analyzed. It can be "parsing", "binding", "viewinvariant", "biomotion", "transitionalprobabilities", "facerecognition", "identityandview", "slowness", or "smoothness".
