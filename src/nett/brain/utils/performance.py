...
#             raise Exception(
#                 f"Training file: {training_files} was not found in the {path}"
#             )
...
#             _, _, values = _average_in_episode_three_region(
#                 log_df, "agent.x"
#             )  # percents,df,
...
# def _average_in_episode_three_region(
#     log: pd.DataFrame, column: str = "agent.x", transient: int = 90
...
#             log[column],
#             [-0.1, 20 / 3, 40 / 3, 20.1],
#             labels=["Distractor", "Null", "Imprint"],
#         )
...
#             total = (
#                 l[l[column] == "Distractor"].count() + l[l[column] == "Imprint"].count()
#             )
