...
| `NETT_AUX_ALLOW_ZERO` | `""` | `nett_skrl/brain/agent_factory.py:51`<br>`nett_skrl/brain/aux/ppo_aux.py:192` |
| `NETT_AUX_BATCH` | `"0"`, `"256"`, `"512"`, `max_samples` | `nett_skrl/brain/agent_factory.py:66`<br>`nett_skrl/brain/aux/cltt_aux.py:74`<br>`nett_skrl/brain/aux/cltt_ref_aux.py:255`<br>`nett_skrl/brain/aux/cltt_schneider_aux.py:90`<br>`nett_skrl/brain/aux/dual_stream.py:224`<br>`nett_skrl/brain/aux/eoo_aux.py:161`<br>*(+7 more)* |
...
| `NETT_AUX_LOSS` | `"none"` | `nett_skrl/brain/agent_factory.py:30`<br>`examples/campaign_train.py:617`<br>`examples/campaign_train.py:895` |
| `NETT_AUX_STRICT` | `""` | `nett_skrl/brain/aux/ppo_aux.py:416` |
| `NETT_AUX_VICREG_TT_OFFSETS` | `"8"` | `nett_skrl/brain/aux/vicreg_tt_aux.py:87` |
| `NETT_AUX_WEIGHT` | `"0"`, `"0.0"` | `nett_skrl/brain/agent_factory.py:31`<br>`examples/campaign_train.py:618`<br>`examples/campaign_train.py:896` |
| `NETT_BRAINS` | `"7"`, `"8"` | `examples/campaign_train.py:540`<br>`examples/train_binding_8brain_targets.py:41` |
| `NETT_BRAIN_OFFSET` | `"0"`, `'0'` | `examples/campaign_train.py:541`<br>`examples/train_binding_8brain_targets.py:190`<br>`examples/train_binding_8brain_targets.py:208` |
| `NETT_CAMERA_FOV` | `""` | `examples/campaign_train.py:431` |
| `NETT_CHECKPOINT_FREQ` | *(required / no literal default)* | `examples/campaign_train.py:752`<br>`examples/campaign_train.py:753` |
| `NETT_DECOUPLE_ENCODER` | `""` | `nett_skrl/brain/models/utils/features.py:23` |
| `NETT_DESIGN_SHEET` | `sheet` | `examples/campaign_run.py:197`<br>`examples/campaign_train.py:811` |
| `NETT_DEVICE` | `"0 (default`, `"0"` | `examples/campaign_retest.py:126`<br>`examples/campaign_train.py:537`<br>`examples/capture_observations.py:358`<br>`examples/capture_observations.py:585`<br>`examples/train_binding_8brain.py:24`<br>`examples/train_binding_8brain_targets.py:35` |
...
| `NETT_ENTROPY` | `"0.01"` | `examples/campaign_train.py:568` |
...
| `NETT_EXPERIMENT` | `"binding"` | `examples/campaign_train.py:521`<br>`examples/train_binding_8brain_targets.py:134` |
...
| `NETT_GPU_BUFFER_BUDGET_GB` | `"4.0"` | `examples/campaign_train.py:643` |
...
| `NETT_HIDDEN_SIZES` | `""` | `examples/campaign_train.py:562` |
| `NETT_IMPRINT` | `_EXP_MAP[EXP][2]`, `default_imprint` | `examples/campaign_train.py:528`<br>`examples/train_binding_8brain_targets.py:145` |
...
| `NETT_MAX_ENVS` | `"112"`, `"32"` | `examples/campaign_train.py:543`<br>`examples/train_binding_8brain_targets.py:38` |
| `NETT_MEDIA_ROOT` | `media` | `examples/campaign_run.py:198`<br>`examples/campaign_train.py:812` |
| `NETT_MEMORY_DEVICE` | *(required / no literal default)* | `nett_skrl/brain/hybrid_memory.py:128`<br>`examples/campaign_train.py:653` |
| `NETT_MINIBATCHES` | `"16"` | `examples/campaign_train.py:765`<br>`examples/campaign_train.py:894`<br>`examples/train_binding_8brain_targets.py:155` |
| `NETT_MODEL` | `""` | `examples/campaign_train.py:517` |
...
| `NETT_OUT_ROOT` | `"~/nett_campaign"` | `examples/campaign_retest_launch.py:44`<br>`examples/campaign_train.py:682` |
...
| `NETT_RES` | `"128"`, `"256"` | `examples/campaign_run.py:180`<br>`examples/campaign_train.py:545`<br>`examples/count_params.py:17`<br>`examples/sweep_params.py:12`<br>`examples/train_binding_8brain_targets.py:40` |
...
| `NETT_REWARD_TYPES` | `"closeness"` | `examples/campaign_train.py:549` |
| `NETT_ROLLOUTS` | `"8000"` | `examples/campaign_train.py:579`<br>`examples/campaign_train.py:720` |
| `NETT_RUN_NAME` | `""` | `examples/campaign_train.py:696` |
...
| `NETT_SEG_QUERIES` | `"2"` | `nett_skrl/body/wrappers/gwm_seg.py:99`<br>`nett_skrl/body/wrappers/motok_seg.py:126`<br>`examples/campaign_train.py:611` |
...
| `NETT_STEPS` | `"500"`, `'500'` | `examples/campaign_train.py:792`<br>`examples/campaign_train.py:847` |
| `NETT_STRICT_DETERMINISM` | `"0"` | `nett_skrl/runtime/task.py:187` |
| `NETT_TAG` | `""` | `examples/train_binding_8brain_targets.py:129` |
| `NETT_TASK_MEMORY` | `"1"` | `examples/campaign_train.py:849`<br>`examples/train_binding_8brain_targets.py:216`<br>`examples/train_replicate_single.py:121`<br>`examples/train_replicate_single.py:122` |
...
| `NETT_TEST_EPS` | `"20"`, `str(config.get("episodes", {}` | `examples/campaign_retest.py:68`<br>`examples/campaign_train.py:846` |
...
| `NETT_TRAIN_EPS` | `"2000"` | `examples/campaign_train.py:542`<br>`examples/train_binding_8brain_targets.py:42` |
...
| `NETT_WANDB_MODE` | `"offline"`, `"online"` | `examples/campaign_retest.py:71`<br>`examples/campaign_retest_launch.py:82`<br>`examples/campaign_train.py:789`<br>`examples/train_binding_8brain_targets.py:174` |
