...
|---|---|---|
| `NETT_ADAM_EPS` | `""`, `"skrl-default"` | `nett_skrl/brain/ppo_metrics.py:263`<br>`examples/campaign_train.py:1273`<br>`examples/campaign_train.py:1308` |
| `NETT_ADV_NORM` | `"rollout"` | `nett_skrl/brain/ppo_metrics.py:276`<br>`examples/campaign_train.py:1274`<br>`examples/campaign_train.py:1309` |
...
| `NETT_AUX_BATCH` | `"0"`, `"256"`, `"512"`, `32`, `48`, `96` | `nett_skrl/brain/agent_factory.py:66`<br>`nett_skrl/brain/aux/cltt_aux.py:74`<br>`nett_skrl/brain/aux/cltt_ref_aux.py:854`<br>`nett_skrl/brain/aux/cltt_schneider_aux.py:90`<br>`nett_skrl/brain/aux/dual_stream.py:224`<br>`nett_skrl/brain/aux/eoo_aux.py:161`<br>*(+7 more)* |
| `NETT_AUX_CLTT_CHANNELS_PER_FRAME` | *(required / no literal default)* | `nett_skrl/brain/aux/cltt_views.py:31` |
| `NETT_AUX_CLTT_MASK_POSITIVE_TWIN` | `True` | `nett_skrl/brain/aux/cltt_ref_aux.py:841` |
| `NETT_AUX_CLTT_PATCH_OFFSET` | `8` | `nett_skrl/brain/aux/token_term.py:223` |
| `NETT_AUX_CLTT_REF_DIAG` | `False` | `nett_skrl/brain/aux/cltt_patch_aux.py:98`<br>`nett_skrl/brain/aux/cltt_ref_aux.py:835` |
| `NETT_AUX_CLTT_REF_OFFSETS` | `'1,2'` | `nett_skrl/brain/aux/cltt_ref_aux.py:844` |
| `NETT_AUX_CLTT_REF_TEMP` | `"0.5"` | `nett_skrl/brain/aux/cltt_ref_aux.py:855` |
| `NETT_AUX_CLTT_REF_WEIGHT` | `1.0` | `nett_skrl/brain/aux/with_cltt_ref.py:79` |
| `NETT_AUX_CLTT_STACK_OFFSETS` | `'2,4'` | `nett_skrl/brain/aux/cltt_ref_aux.py:844` |
...
| `NETT_AUX_LOSS` | `"none"` | `nett_skrl/brain/agent_factory.py:30`<br>`examples/campaign_train.py:979`<br>`examples/campaign_train.py:1267` |
...
| `NETT_AUX_WEIGHT` | `"0"`, `"0.0"` | `nett_skrl/brain/agent_factory.py:31`<br>`examples/campaign_train.py:984`<br>`examples/campaign_train.py:1268` |
| `NETT_AUX_WEIGHT_OVERRIDE` | *(required / no literal default)* | `examples/campaign_train.py:984` |
| `NETT_BRAINS` | `"7"`, `"8"` | `examples/campaign_train.py:890`<br>`examples/train_binding_8brain_targets.py:41` |
| `NETT_BRAIN_OFFSET` | `"0"`, `'0'` | `examples/campaign_train.py:891`<br>`examples/train_binding_8brain_targets.py:190`<br>`examples/train_binding_8brain_targets.py:208` |
| `NETT_CAMERA_FOV` | `""` | `examples/campaign_train.py:738` |
| `NETT_CAMPAIGN_DIR` | `str(Path.home() / "nett_campaign")` | `examples/campaign_run.py:37` |
| `NETT_CHECKPOINT_FREQ` | *(required / no literal default)* | `examples/campaign_train.py:1120`<br>`examples/campaign_train.py:1121` |
| `NETT_DECOUPLE_ENCODER` | `""` | `nett_skrl/brain/models/utils/features.py:24` |
| `NETT_DESIGN_SHEET` | *(caller-supplied: `sheet`)* | `examples/campaign_run.py:197`<br>`examples/campaign_train.py:1183` |
| `NETT_DEVICE` | `"0 (default)"`, `"0"` | `examples/campaign_retest.py:126`<br>`examples/campaign_train.py:887`<br>`examples/capture_observations.py:358`<br>`examples/capture_observations.py:585`<br>`examples/train_binding_8brain.py:24`<br>`examples/train_binding_8brain_targets.py:35` |
...
| `NETT_DIAG_PEB` | `"off"` | `nett_skrl/brain/ppo_metrics.py:90`<br>`examples/campaign_train.py:1274`<br>`examples/campaign_train.py:1310` |
...
| `NETT_ENTROPY` | `"0.01"` | `examples/campaign_train.py:924` |
...
| `NETT_EXPERIMENT` | `"binding"` | `examples/campaign_train.py:871`<br>`examples/train_binding_8brain_targets.py:134` |
...
| `NETT_EYE_ASPECT_FREE` | `False` | `examples/campaign_train.py:843` |
| `NETT_EYE_H` | *(required / no literal default)* | `examples/count_params.py:68` |
| `NETT_EYE_RES` | `""` | `examples/campaign_train.py:829` |
...
| `NETT_FRAMESTACK_N` | `"2"` | `nett_skrl/body/wrappers/framestack.py:48`<br>`examples/campaign_train.py:188` |
...
| `NETT_GPU_BUFFER_BUDGET_GB` | `"4.0"` | `examples/campaign_train.py:1011` |
...
| `NETT_HIDDEN_SIZES` | `""` | `examples/campaign_train.py:918` |
| `NETT_IMPRINT` | `_EXP_MAP[EXP][2]`, *(caller-supplied: `default_imprint`)* | `examples/campaign_train.py:878`<br>`examples/train_binding_8brain_targets.py:145` |
...
| `NETT_KL_THRESHOLD` | `"0.5"` | `examples/campaign_train.py:930` |
| `NETT_LEARNING_RATE` | `"3e-4"` | `examples/campaign_train.py:1137` |
...
| `NETT_MAX_ENVS` | `"112"`, `"32"` | `examples/campaign_train.py:898`<br>`examples/train_binding_8brain_targets.py:38` |
| `NETT_MAX_LOG_STD` | `""` | `examples/campaign_train.py:855` |
| `NETT_MEDIA_ROOT` | *(caller-supplied: `media`)* | `examples/campaign_run.py:198`<br>`examples/campaign_train.py:1184` |
| `NETT_MEMORY_DEVICE` | *(required / no literal default)* | `nett_skrl/brain/hybrid_memory.py:128`<br>`examples/campaign_train.py:1021` |
| `NETT_MINIBATCHES` | `"16"` | `examples/campaign_train.py:1133`<br>`examples/campaign_train.py:1266`<br>`examples/train_binding_8brain_targets.py:155` |
| `NETT_MODEL` | `""` | `examples/campaign_train.py:867` |
...
| `NETT_OUT_ROOT` | `"~/nett_campaign"` | `examples/campaign_retest_launch.py:44`<br>`examples/campaign_train.py:1050` |
...
| `NETT_PHYSX_PER_ENV_MIB` | `8.0` | `nett_skrl/environment/physx_strategy.py:72` |
...
| `NETT_RES` | `"128"`, `"256"` | `examples/campaign_run.py:180`<br>`examples/campaign_train.py:900`<br>`examples/sweep_params.py:12`<br>`examples/train_binding_8brain_targets.py:40` |
...
| `NETT_REWARD_TYPES` | `"closeness"` | `examples/campaign_train.py:905` |
| `NETT_ROLLOUTS` | `"8000"` | `nett_skrl/body/wrappers/segmentation.py:85`<br>`examples/campaign_train.py:941`<br>`examples/campaign_train.py:1088` |
| `NETT_RUN_NAME` | `""` | `examples/campaign_train.py:1064` |
...
| `NETT_SEG_CADENCE` | `"online"` | `nett_skrl/body/wrappers/segmentation.py:74`<br>`examples/campaign_train.py:895` |
...
| `NETT_SEG_QUERIES` | `"2"` | `nett_skrl/body/wrappers/gwm_seg.py:99`<br>`nett_skrl/body/wrappers/motok_seg.py:142`<br>`examples/campaign_train.py:973` |
...
| `NETT_SLOTC_EMA` | `0.996` | `nett_skrl/brain/aux/slot_contrast_aux.py:411` |
| `NETT_SLOTC_NO_DETACH` | `False` | `nett_skrl/brain/aux/slot_contrast_aux.py:417` |
| `NETT_SLOTC_SLOTS` | `6` | `nett_skrl/brain/aux/slot_contrast_aux.py:406` |
| `NETT_SLOTC_TEMP` | `0.1` | `nett_skrl/brain/aux/slot_contrast_aux.py:408` |
| `NETT_SLOTC_W_REC` | `1.0` | `nett_skrl/brain/aux/slot_contrast_aux.py:410` |
| `NETT_SLOTC_W_SS` | `0.5` | `nett_skrl/brain/aux/slot_contrast_aux.py:409` |
...
| `NETT_STEPS` | `"500"`, `'500'` | `examples/campaign_train.py:1164`<br>`examples/campaign_train.py:1219` |
| `NETT_STRICT_DETERMINISM` | `"0"` | `nett_skrl/runtime/task.py:187` |
| `NETT_TAG` | `""` | `examples/train_binding_8brain_targets.py:129` |
| `NETT_TASK_MEMORY` | `"1"` | `examples/campaign_train.py:1221`<br>`examples/train_binding_8brain_targets.py:216`<br>`examples/train_replicate_single.py:121`<br>`examples/train_replicate_single.py:122` |
...
| `NETT_TEST_EPS` | `"20"`, `str(config.get("episodes", {}).get("test", 20))` | `examples/campaign_retest.py:68`<br>`examples/campaign_train.py:1218` |
...
| `NETT_TRAIN_EPS` | `"2000"` | `examples/campaign_train.py:897`<br>`examples/train_binding_8brain_targets.py:42` |
| `NETT_TRAIN_STEP_LOGGING` | `False` | `examples/campaign_train.py:1209` |
...
| `NETT_VALUE_STD` | `"on"` | `nett_skrl/brain/agent_factory.py:109`<br>`examples/campaign_train.py:1273`<br>`examples/campaign_train.py:1307` |
...
| `NETT_WANDB_MODE` | `"offline"`, `"online"` | `examples/campaign_retest.py:71`<br>`examples/campaign_retest_launch.py:82`<br>`examples/campaign_train.py:1161`<br>`examples/train_binding_8brain_targets.py:174` |
