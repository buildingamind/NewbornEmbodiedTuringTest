...
|---|---|---|
| `NETT_ADAM_EPS` | `""`, `"skrl-default"` | `nett_skrl/brain/ppo_metrics.py:263`<br>`examples/campaign_train.py:1265`<br>`examples/campaign_train.py:1300` |
| `NETT_ADV_NORM` | `"rollout"` | `nett_skrl/brain/ppo_metrics.py:276`<br>`examples/campaign_train.py:1266`<br>`examples/campaign_train.py:1301` |
...
| `NETT_AUX_LOSS` | `"none"` | `nett_skrl/brain/agent_factory.py:30`<br>`examples/campaign_train.py:971`<br>`examples/campaign_train.py:1259` |
...
| `NETT_AUX_WEIGHT` | `"0"`, `"0.0"` | `nett_skrl/brain/agent_factory.py:31`<br>`examples/campaign_train.py:976`<br>`examples/campaign_train.py:1260` |
| `NETT_AUX_WEIGHT_OVERRIDE` | *(required / no literal default)* | `examples/campaign_train.py:976` |
| `NETT_BRAINS` | `"7"`, `"8"` | `examples/campaign_train.py:882`<br>`examples/train_binding_8brain_targets.py:41` |
| `NETT_BRAIN_OFFSET` | `"0"`, `'0'` | `examples/campaign_train.py:883`<br>`examples/train_binding_8brain_targets.py:190`<br>`examples/train_binding_8brain_targets.py:208` |
| `NETT_CAMERA_FOV` | `""` | `examples/campaign_train.py:735` |
| `NETT_CAMPAIGN_DIR` | `str(Path.home() / "nett_campaign")` | `examples/campaign_run.py:37` |
| `NETT_CHECKPOINT_FREQ` | *(required / no literal default)* | `examples/campaign_train.py:1112`<br>`examples/campaign_train.py:1113` |
| `NETT_DECOUPLE_ENCODER` | `""` | `nett_skrl/brain/models/utils/features.py:24` |
| `NETT_DESIGN_SHEET` | *(caller-supplied: `sheet`)* | `examples/campaign_run.py:197`<br>`examples/campaign_train.py:1175` |
| `NETT_DEVICE` | `"0 (default)"`, `"0"` | `examples/campaign_retest.py:126`<br>`examples/campaign_train.py:879`<br>`examples/capture_observations.py:358`<br>`examples/capture_observations.py:585`<br>`examples/train_binding_8brain.py:24`<br>`examples/train_binding_8brain_targets.py:35` |
...
| `NETT_DIAG_PEB` | `"off"` | `nett_skrl/brain/ppo_metrics.py:90`<br>`examples/campaign_train.py:1266`<br>`examples/campaign_train.py:1302` |
...
| `NETT_ENTROPY` | `"0.01"` | `examples/campaign_train.py:916` |
...
| `NETT_EXPERIMENT` | `"binding"` | `examples/campaign_train.py:863`<br>`examples/train_binding_8brain_targets.py:134` |
...
| `NETT_EYE_RES` | `""` | `examples/campaign_train.py:826` |
...
| `NETT_GPU_BUFFER_BUDGET_GB` | `"4.0"` | `examples/campaign_train.py:1003` |
...
| `NETT_HIDDEN_SIZES` | `""` | `examples/campaign_train.py:910` |
| `NETT_IMPRINT` | `_EXP_MAP[EXP][2]`, *(caller-supplied: `default_imprint`)* | `examples/campaign_train.py:870`<br>`examples/train_binding_8brain_targets.py:145` |
...
| `NETT_KL_THRESHOLD` | `"0.5"` | `examples/campaign_train.py:922` |
| `NETT_LEARNING_RATE` | `"3e-4"` | `examples/campaign_train.py:1129` |
...
| `NETT_MAX_ENVS` | `"112"`, `"32"` | `examples/campaign_train.py:890`<br>`examples/train_binding_8brain_targets.py:38` |
| `NETT_MAX_LOG_STD` | `""` | `examples/campaign_train.py:847` |
| `NETT_MEDIA_ROOT` | *(caller-supplied: `media`)* | `examples/campaign_run.py:198`<br>`examples/campaign_train.py:1176` |
| `NETT_MEMORY_DEVICE` | *(required / no literal default)* | `nett_skrl/brain/hybrid_memory.py:128`<br>`examples/campaign_train.py:1013` |
| `NETT_MINIBATCHES` | `"16"` | `examples/campaign_train.py:1125`<br>`examples/campaign_train.py:1258`<br>`examples/train_binding_8brain_targets.py:155` |
| `NETT_MODEL` | `""` | `examples/campaign_train.py:859` |
...
| `NETT_OUT_ROOT` | `"~/nett_campaign"` | `examples/campaign_retest_launch.py:44`<br>`examples/campaign_train.py:1042` |
...
| `NETT_RES` | `"128"`, `"256"` | `examples/campaign_run.py:180`<br>`examples/campaign_train.py:892`<br>`examples/sweep_params.py:12`<br>`examples/train_binding_8brain_targets.py:40` |
...
| `NETT_STEPS` | `"500"`, `'500'` | `examples/campaign_train.py:1156`<br>`examples/campaign_train.py:1211` |
| `NETT_STRICT_DETERMINISM` | `"0"` | `nett_skrl/runtime/task.py:187` |
| `NETT_TAG` | `""` | `examples/train_binding_8brain_targets.py:129` |
| `NETT_TASK_MEMORY` | `"1"` | `examples/campaign_train.py:1213`<br>`examples/train_binding_8brain_targets.py:216`<br>`examples/train_replicate_single.py:121`<br>`examples/train_replicate_single.py:122` |
...
| `NETT_TEST_EPS` | `"20"`, `str(config.get("episodes", {}).get("test", 20))` | `examples/campaign_retest.py:68`<br>`examples/campaign_train.py:1210` |
...
| `NETT_TRAIN_EPS` | `"2000"` | `examples/campaign_train.py:889`<br>`examples/train_binding_8brain_targets.py:42` |
| `NETT_TRAIN_STEP_LOGGING` | `False` | `examples/campaign_train.py:1201` |
...
| `NETT_VALUE_STD` | `"on"` | `nett_skrl/brain/agent_factory.py:109`<br>`examples/campaign_train.py:1265`<br>`examples/campaign_train.py:1299` |
...
| `NETT_WANDB_MODE` | `"offline"`, `"online"` | `examples/campaign_retest.py:71`<br>`examples/campaign_retest_launch.py:82`<br>`examples/campaign_train.py:1153`<br>`examples/train_binding_8brain_targets.py:174` |
