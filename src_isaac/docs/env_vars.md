...
| `NETT_BRAIN_OFFSET` | `"0"`, `'0'` | `examples/campaign_train.py:525`<br>`examples/train_binding_8brain_targets.py:190`<br>`examples/train_binding_8brain_targets.py:208` |
| `NETT_CAMERA_FOV` | `""` | `examples/campaign_train.py:415` |
| `NETT_CHECKPOINT_FREQ` | *(required / no literal default)* | `examples/campaign_train.py:736`<br>`examples/campaign_train.py:737` |
| `NETT_DECOUPLE_ENCODER` | `""` | `nett_skrl/brain/models/utils/features.py:23` |
| `NETT_DESIGN_SHEET` | `sheet` | `examples/campaign_run.py:197`<br>`examples/campaign_train.py:795` |
| `NETT_DEVICE` | `"0 (default`, `"0"` | `examples/campaign_retest.py:126`<br>`examples/campaign_train.py:521`<br>`examples/capture_observations.py:358`<br>`examples/capture_observations.py:585`<br>`examples/train_binding_8brain.py:24`<br>`examples/train_binding_8brain_targets.py:35` |
...
| `NETT_ENTROPY` | `"0.01"` | `examples/campaign_train.py:552` |
...
| `NETT_EXPERIMENT` | `"binding"` | `examples/campaign_train.py:505`<br>`examples/train_binding_8brain_targets.py:134` |
...
| `NETT_GPU_BUFFER_BUDGET_GB` | `"4.0"` | `examples/campaign_train.py:627` |
...
| `NETT_HIDDEN_SIZES` | `""` | `examples/campaign_train.py:546` |
| `NETT_IMPRINT` | `_EXP_MAP[EXP][2]`, `default_imprint` | `examples/campaign_train.py:512`<br>`examples/train_binding_8brain_targets.py:145` |
...
| `NETT_MINIBATCHES` | `"16"` | `examples/campaign_train.py:749`<br>`examples/campaign_train.py:878`<br>`examples/train_binding_8brain_targets.py:155` |
| `NETT_MODEL` | `""` | `examples/campaign_train.py:501` |
...
| `NETT_OUT_ROOT` | `"~/nett_campaign"` | `examples/campaign_retest_launch.py:44`<br>`examples/campaign_train.py:666` |
...
| `NETT_RES` | `"128"`, `"256"` | `examples/campaign_run.py:180`<br>`examples/campaign_train.py:529`<br>`examples/count_params.py:17`<br>`examples/sweep_params.py:12`<br>`examples/train_binding_8brain_targets.py:40` |
...
| `NETT_REWARD_TYPES` | `"closeness"` | `examples/campaign_train.py:533` |
| `NETT_ROLLOUTS` | `"8000"` | `examples/campaign_train.py:563`<br>`examples/campaign_train.py:704` |
| `NETT_RUN_NAME` | `""` | `examples/campaign_train.py:680` |
...
| `NETT_SEG_QUERIES` | `"2"` | `nett_skrl/body/wrappers/gwm_seg.py:99`<br>`nett_skrl/body/wrappers/motok_seg.py:126`<br>`examples/campaign_train.py:595` |
...
| `NETT_SLOTC_DIM` | `slot_dim` | `nett_skrl/brain/aux/slot_contrast_aux.py:381` |
| `NETT_SLOTC_EMA` | `ema` | `nett_skrl/brain/aux/slot_contrast_aux.py:385` |
| `NETT_SLOTC_SLOTS` | `slots` | `nett_skrl/brain/aux/slot_contrast_aux.py:380` |
| `NETT_SLOTC_TEMP` | `temperature` | `nett_skrl/brain/aux/slot_contrast_aux.py:382` |
| `NETT_SLOTC_W_REC` | `w_rec` | `nett_skrl/brain/aux/slot_contrast_aux.py:384` |
| `NETT_SLOTC_W_SS` | `w_ss` | `nett_skrl/brain/aux/slot_contrast_aux.py:383` |
...
| `NETT_STEPS` | `"500"`, `'500'` | `examples/campaign_train.py:776`<br>`examples/campaign_train.py:831` |
| `NETT_STRICT_DETERMINISM` | `"0"` | `nett_skrl/runtime/task.py:187` |
| `NETT_TAG` | `""` | `examples/train_binding_8brain_targets.py:129` |
| `NETT_TASK_MEMORY` | `"1"` | `examples/campaign_train.py:833`<br>`examples/train_binding_8brain_targets.py:216`<br>`examples/train_replicate_single.py:121`<br>`examples/train_replicate_single.py:122` |
...
| `NETT_TEST_EPS` | `"20"`, `str(config.get("episodes", {}` | `examples/campaign_retest.py:68`<br>`examples/campaign_train.py:830` |
...
| `NETT_TRAIN_EPS` | `"2000"` | `examples/campaign_train.py:526`<br>`examples/train_binding_8brain_targets.py:42` |
...
| `NETT_WANDB_MODE` | `"offline"`, `"online"` | `examples/campaign_retest.py:71`<br>`examples/campaign_retest_launch.py:82`<br>`examples/campaign_train.py:773`<br>`examples/train_binding_8brain_targets.py:174` |
