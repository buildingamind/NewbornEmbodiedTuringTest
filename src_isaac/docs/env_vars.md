...
| `NETT_SLOTC_DIM` | `slot_dim` | `nett_skrl/brain/aux/slot_contrast_aux.py:366` |
| `NETT_SLOTC_EMA` | `ema` | `nett_skrl/brain/aux/slot_contrast_aux.py:370` |
| `NETT_SLOTC_SLOTS` | `slots` | `nett_skrl/brain/aux/slot_contrast_aux.py:365` |
| `NETT_SLOTC_TEMP` | `temperature` | `nett_skrl/brain/aux/slot_contrast_aux.py:367` |
| `NETT_SLOTC_W_REC` | `w_rec` | `nett_skrl/brain/aux/slot_contrast_aux.py:369` |
| `NETT_SLOTC_W_SS` | `w_ss` | `nett_skrl/brain/aux/slot_contrast_aux.py:368` |
