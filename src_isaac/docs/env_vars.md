...
| `NETT_AUX_AFF_BATCH` | `32` | `nett_skrl/brain/aux/token_term.py:203` |
...
| `NETT_AUX_EGO_TRANSIT_FRAC` | `0.5` | `nett_skrl/brain/aux/ego_residual_aux.py:122` |
...
| `NETT_AUX_PATCH_BATCH` | `512` | `nett_skrl/brain/aux/token_term.py:203` |
| `NETT_AUX_PATCH_M` | `8` | `nett_skrl/brain/aux/cltt_patch_aux.py:89` |
| `NETT_AUX_PATCH_TEMP` | `0.5` | `nett_skrl/brain/aux/cltt_patch_aux.py:90` |
| `NETT_AUX_PATCH_TOPG` | `max(1, self.n_tokens // 2)` | `nett_skrl/brain/aux/cltt_patch_aux.py:88` |
| `NETT_AUX_SLOTFG_BATCH` | `32` | `nett_skrl/brain/aux/token_term.py:203` |
...
| `NETT_AUX_SLOTFG_OFFSET` | `8` | `nett_skrl/brain/aux/token_term.py:204` |
