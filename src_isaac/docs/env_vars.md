...
| `NETT_AUX_ALLOW_ZERO` | `""` | `nett_skrl/brain/agent_factory.py:51`<br>`nett_skrl/brain/aux/ppo_aux.py:218` |
...
| `NETT_AUX_STRICT` | `""`, `False` | `nett_skrl/brain/aux/gwm_dual_aux.py:29`<br>`nett_skrl/brain/aux/ppo_aux.py:443` |
...
| `NETT_ENTROPY` | `"0.01"` | `examples/campaign_train.py:667` |
...
| `NETT_EXPERIMENT` | `"binding"` | `examples/campaign_train.py:620`<br>`examples/train_binding_8brain_targets.py:134` |
...
| `NETT_GPU_BUFFER_BUDGET_GB` | `"4.0"` | `examples/campaign_train.py:742` |
...
| `NETT_HIDDEN_SIZES` | `""` | `examples/campaign_train.py:661` |
| `NETT_IMPRINT` | `_EXP_MAP[EXP][2]`, `default_imprint` | `examples/campaign_train.py:627`<br>`examples/train_binding_8brain_targets.py:145` |
...
| `NETT_MAX_ENVS` | `"112"`, `"32"` | `examples/campaign_train.py:642`<br>`examples/train_binding_8brain_targets.py:38` |
| `NETT_MEDIA_ROOT` | `media` | `examples/campaign_run.py:198`<br>`examples/campaign_train.py:911` |
| `NETT_MEMORY_DEVICE` | *(required / no literal default)* | `nett_skrl/brain/hybrid_memory.py:128`<br>`examples/campaign_train.py:752` |
| `NETT_MINIBATCHES` | `"16"` | `examples/campaign_train.py:864`<br>`examples/campaign_train.py:993`<br>`examples/train_binding_8brain_targets.py:155` |
| `NETT_MODEL` | `""` | `examples/campaign_train.py:616` |
...
| `NETT_OUT_ROOT` | `"~/nett_campaign"` | `examples/campaign_retest_launch.py:44`<br>`examples/campaign_train.py:781` |
...
| `NETT_RES` | `"128"`, `"256"` | `examples/campaign_run.py:180`<br>`examples/campaign_train.py:644`<br>`examples/sweep_params.py:12`<br>`examples/train_binding_8brain_targets.py:40` |
...
| `NETT_REWARD_TYPES` | `"closeness"` | `examples/campaign_train.py:648` |
| `NETT_ROLLOUTS` | `"8000"` | `examples/campaign_train.py:678`<br>`examples/campaign_train.py:819` |
| `NETT_RUN_NAME` | `""` | `examples/campaign_train.py:795` |
...
| `NETT_SEG_QUERIES` | `"2"` | `nett_skrl/body/wrappers/gwm_seg.py:99`<br>`nett_skrl/body/wrappers/motok_seg.py:126`<br>`examples/campaign_train.py:710` |
...
| `NETT_STEPS` | `"500"`, `'500'` | `examples/campaign_train.py:891`<br>`examples/campaign_train.py:946` |
| `NETT_STRICT_DETERMINISM` | `"0"` | `nett_skrl/runtime/task.py:187` |
| `NETT_TAG` | `""` | `examples/train_binding_8brain_targets.py:129` |
| `NETT_TASK_MEMORY` | `"1"` | `examples/campaign_train.py:948`<br>`examples/train_binding_8brain_targets.py:216`<br>`examples/train_replicate_single.py:121`<br>`examples/train_replicate_single.py:122` |
...
| `NETT_TEST_EPS` | `"20"`, `str(config.get("episodes", {}` | `examples/campaign_retest.py:68`<br>`examples/campaign_train.py:945` |
...
| `NETT_TRAIN_EPS` | `"2000"` | `examples/campaign_train.py:641`<br>`examples/train_binding_8brain_targets.py:42` |
...
| `NETT_WANDB_MODE` | `"offline"`, `"online"` | `examples/campaign_retest.py:71`<br>`examples/campaign_retest_launch.py:82`<br>`examples/campaign_train.py:888`<br>`examples/train_binding_8brain_targets.py:174` |
