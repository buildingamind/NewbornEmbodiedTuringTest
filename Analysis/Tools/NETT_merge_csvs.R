...
data_wd <- "/Users/samanthawood/Documents/WoodLab/AI Papers/EmbodiedPipeline/Segmentation/"
results_wd <- "/Users/samanthawood/Documents/WoodLab/AI Papers/EmbodiedPipeline/Segmentation/"
...
test_files <- list.files(pattern="test.csv", recursive = FALSE)
